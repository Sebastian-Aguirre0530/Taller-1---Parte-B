...
def Calculo_de_potencia():
    try:
        ...
        print("Ingrese los siguientes datos para calcular la potencia eléctrica:")
        ...
        print(f"Voltaje elegido fue: {voltaje} V")
        print(f"Corriente elegida: {corriente:} A")
...
def calculos_de_volumenes():
    while True:
        ...
        if opcion == "1":
            ...
            tipo_del_prisma = input("Ingrese el número correspondiente (1.1 - 1.4): ").strip()
            
            if tipo_del_prisma == "1.1":
                print(" HAS SELECCIONADO EL PRISMA RECTANGULAR ")
                print(" Ingrese los siguientes datos para calcular el volumen del prisma rectangular:")
            ...
            elif tipo_del_prisma == "1.2":
                print(" HAS SELECCIONADO EL PRISMA TRIANGULAR ")
                print(" Ingrese los siguientes datos para calcular el volumen del prisma triangular:")
            ...
            elif tipo_del_prisma == "1.3":
                print("  HAS SELECCIONADO EL PRISMA PENTAGONAL ")
                print(" Ingrese los siguientes datos para calcular el volumen del prisma pentagonal:")
            ...
            elif tipo_del_prisma == "1.4":
                print("  HAS SELECCIONADO EL PRISMA HEXAGONAL ")
                print(" Ingrese los siguientes datos para calcular el volumen del prisma hexagonal:")
                apotema = float(input("Ingrese el apotema (en metros): "))
                perimetro = float(input("Ingrese el perímetro (en metros): "))
                altura = float(input("Ingrese la altura (en metros): "))
                volumen = (perimetro * apotema / 2) * altura
            ...
            print(" PIRÁMIDE ")
            print(" Has seleccionado calcular el volumen de una pirámide.")
            ...
            tipo_de_piramides = input("Ingrese el número correspondiente (2.1 - 2.4): ").strip()
            
            if tipo_de_piramides == "2.1":
                print(" HAS SELECCIONADO LA PIRÁMIDE RECTANGULAR ")
                print(" Ingrese los siguientes datos para calcular el volumen de la pirámide rectangular:")
            ...
            elif tipo_de_piramides == "2.2":
                print("  HAS SELECCIONADO LA PIRÁMIDE TRIANGULAR ")
                print(" Ingrese los siguientes datos para calcular el volumen de la pirámide triangular:")
                base = float(input("Ingrese la base del triángulo (en metros): "))
                altura_triangulo = float(input("Ingrese la altura del triángulo (en metros): "))
            ...
            elif tipo_de_piramides == "2.3":
                print("   HAS SELECCIONADO LA PIRÁMIDE PENTAGONAL ")
                print(" Ingrese los siguientes datos para calcular el volumen de la pirámide pentagonal:")
                apotema = float(input("Ingrese el apotema (en metros): "))
                perimetro = float(input("Ingrese el perímetro (en metros): "))
                altura = float(input("Ingrese la altura (en metros): "))
            ...
            elif tipo_de_piramides == "2.4":
                print("  HAS SELECCIONADO LA PIRÁMIDE HEXAGONAL ")
                print(" Ingrese los siguientes datos para calcular el volumen de la pirámide hexagonal:")
                apotema = float(input("Ingrese el apotema (en metros): "))
                perimetro = float(input("Ingrese el perímetro (en metros): "))
                altura = float(input("Ingrese la altura (en metros): "))
                volumen = ((perimetro * apotema / 2) * altura) / 3
            ...
            print(" CONO TRUNCADO ")
            print(" Has seleccionado calcular el volumen de un cono truncado.")
            print("Ingrese los siguientes datos para calcular el volumen del cono truncado:")
            altura = float(input("Ingrese la altura (en metros): "))
            ...
            print("CILINDRO ")
            print(" Has seleccionado calcular el volumen de un cilindro.")
            print("Ingrese los siguientes datos para calcular el volumen del cilindro:")
            altura = float(input("Ingrese la altura (en metros): "))
...
def escoger_robot():
      ...
      if opcion_del_robot == "1":
            print(" Has escogido el robot cilíndrico")
            ...
            print(" Has escogido el robot cartesiano")
            ...
            print(" Has escogido el robot esferico")
...
def programa_confirmacion():
    ...
    while True:
        contador += 1
        print(f" Se esta ejecutando el programa #{contador} ---")
        print("Tarea principal en ejecución...")
        print("Procesando...")
        print("Tarea completada")
        
        respuesta = input(" ¿Desea continuar? (Si/No): ").lower().strip()
        
        if respuesta in ["no", "n", "No", "NO" , "N", "nO"]:
            print(f" ¡Hasta luego! , se cerro el programa. y tu total de ejecuciones fue: {contador}")
            break
...
### Punto de entrada principal para el menú del taller 1 parte B
